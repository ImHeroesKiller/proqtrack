...
import { createProjectManagementMigration } from "./project-management-migration.js";
...
const projectManagementMigration = createProjectManagementMigration({
  readDB,
  writeDB,
  DEFAULT_ORG_ID,
...
const { defaultModules, migrateV7 } = projectManagementMigration;

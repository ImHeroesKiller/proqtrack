...
window.PM = {
  ...
  async saveProject(e, id) {
    ...
    const data = {
      ...
      attendanceSource: formValue(fd, "attendanceSource") === "visit" ? "visit" : "manual",
  ...
  viewProject(id) {
    ...
    modal(
      ...
      <div class="pm-detail-grid">
        ...
        <div class="pm-detail-card"><div class="pm-detail-label">Target</div><div class="pm-detail-value">${p.targetVisits || "-"} visit · ${p.targetOutlets || "-"} outlet</div></div><div class="pm-detail-card"><div class="pm-detail-label">Outlet Approval</div><div class="pm-detail-value">${p.outletApprovalMode === "manual" ? "Manual Approval" : "Auto Approved"}</div></div>
        <div class="pm-detail-card"><div class="pm-detail-label">Attendance</div><div class="pm-detail-value">${p.attendanceSource === "visit" ? "Dari Visit" : "Absen Manual"}</div></div>

  ...
  openModal('New Outlet', `
    <form data-outlet-form="1" data-pqt-onsubmit="FT.createOutlet(event)">
      ...
      <div class="form-group">
        ...
        <div class="filter-row" style="margin-bottom:8px"><input class="input search-input" id="outletMapSearch" placeholder="Cari alamat / nama jalan / tempat..."><button type="button" class="btn btn-secondary" data-pqt-onclick="FS.searchOutletMap()">Cari</button><button type="button" class="btn btn-secondary" id="outletLocBtn" data-pqt-onclick="FS.captureOutletLocation()">Lokasi Saya</button></div>

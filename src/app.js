  ...
  openModal('New Outlet', `
    <form data-outlet-form="1" data-pqt-onsubmit="FT.createOutlet(event)">
      ...
      <div class="form-group">
        ...
        <div class="filter-row" style="margin-bottom:8px"><input class="input search-input" id="outletMapSearch" placeholder="Cari alamat / nama jalan / tempat..."><button type="button" class="btn btn-secondary" id="outletMapSearchBtn" data-pqt-onclick="FS.searchOutletMap()">Cari</button><button type="button" class="btn btn-secondary" id="outletLocBtn" data-pqt-onclick="FS.captureOutletLocation()">Lokasi Saya</button></div>
        <div id="outletPickMap" style="height:240px;border-radius:14px;border:1px solid var(--gray-200);overflow:hidden"></div>
        <div class="am-muted" id="outletMapHint" style="margin-top:6px">Cari alamat, klik peta, atau gunakan lokasi perangkat. Koordinat akan dikunci sebelum pencarian alamat.</div>
...
window.FT.editOutlet = function(id) {
  ...
  openModal('Edit Outlet', `
    <form data-outlet-form="1" data-pqt-onsubmit="FT.updateOutlet(event, ${jsArg(id)})">
      ...
      <div class="form-group"><label class="label">Lokasi di peta</label><div class="filter-row" style="margin-bottom:8px"><input class="input search-input" id="outletMapSearch" placeholder="Cari alamat / nama jalan / tempat..."><button type="button" class="btn btn-secondary" id="outletMapSearchBtn" data-pqt-onclick="FS.searchOutletMap()">Cari</button><button type="button" class="btn btn-secondary" id="outletLocBtn" data-pqt-onclick="FS.captureOutletLocation()">Lokasi Saya</button></div><div id="outletPickMap" style="height:240px;border-radius:14px;border:1px solid var(--gray-200);overflow:hidden"></div><div class="am-muted" id="outletMapHint" style="margin-top:6px">Titik saat ini ditampilkan. Klik peta, cari alamat, atau gunakan lokasi perangkat untuk memperbarui titik.</div><a id="outletOpenMaps" class="btn btn-secondary btn-sm" href="#" target="_blank" rel="noopener noreferrer" style="display:none;margin-top:8px">Buka Maps untuk konfirmasi</a><input type="hidden" name="lat" id="outletLat" value="${esc(model.lat)}" required><input type="hidden" name="lng" id="outletLng" value="${esc(model.lng)}" required><input type="hidden" name="mapLabel" id="outletMapLabel"></div>

const REPORT_LINKS=[['#/reports','Summary'],['#/reports/attendance','Attendance'],['#/reports/employees','Employees'],['#/reports/projects','Clients & Projects'],['#/reports/field','Field Activity'],['#/reports/stocks','Stock'],['#/reports/prices','Prices'],['#/reports/competitors','Competitors'],['#/reports/supervisors','Supervisor'],['#/reports/custom','Custom'],['#/reports/audit','Audit'],['#/reports/templates','Templates'],['#/reports/approvals','Approvals'],['#/reports/schedules','Scheduled']];

...
function buildUatDatabase(){
  ...
  const accounts=[
    ...
    {id:'ACC-UAT-004',email:'dewi.employee@proqtrack.id',password:'demo123',role:'employee',employeeId:'EMP-UAT-004',name:'Dewi Lestari',status:'active',mustChangePassword:false,lastLoginAt:null,createdAt:now,updatedAt:now},
    {id:'ACC-UAT-005',email:'ahmad.employee@proqtrack.id',password:'demo123',role:'employee',employeeId:'EMP-UAT-005',name:'Ahmad Wijaya',status:'suspended',mustChangePassword:false,lastLoginAt:null,createdAt:now,updatedAt:now},
    {id:'ACC-UAT-006',email:'fajar.inactive@proqtrack.id',password:'demo123',role:'employee',employeeId:'EMP-UAT-007',name:'Fajar Nugroho',status:'inactive',mustChangePassword:false,lastLoginAt:null,createdAt:now,updatedAt:now}
  ];

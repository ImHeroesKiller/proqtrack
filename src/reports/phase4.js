...
function tabs(){return `<nav class="rpt-nav" aria-label="Report menu"><a href="#/reports">Summary</a><a href="#/reports/templates" class="${location.hash==='#/reports/templates'?'active':''}">Templates</a><a href="#/reports/approvals" class="${location.hash==='#/reports/approvals'?'active':''}">Approvals</a><a href="#/reports/schedules" class="${location.hash==='#/reports/schedules'?'active':''}">Scheduled</a><a href="#/reports/exports">Export history</a></nav>`}

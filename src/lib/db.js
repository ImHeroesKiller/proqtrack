...
import { createCompetitorPhotoDomain, FIELD_PHOTO_TYPES } from './db-competitor-photo.js';
import { createAttendanceLeaveDomain } from './db-attendance-leave.js';
...
const attendanceLeaveDomain = createAttendanceLeaveDomain({
  getDB,
  saveDB,
  scoped,
  getActor,
...
export function getAttendancePoints() { return attendanceLeaveDomain.getAttendancePoints(); }
export function createAttendancePoint(data) { return attendanceLeaveDomain.createAttendancePoint(data); }
export function getAttendance() { return attendanceLeaveDomain.getAttendance(); }
export function getAttendanceByDate(date) { return attendanceLeaveDomain.getAttendanceByDate(date); }
export function getAttendanceByEmployee(empId) { return attendanceLeaveDomain.getAttendanceByEmployee(empId); }
export function createAttendance(data) { return attendanceLeaveDomain.createAttendance(data); }
export function updateAttendance(id, data) { return attendanceLeaveDomain.updateAttendance(id, data); }
export function checkOutAttendance(id, checkOutAt) { return attendanceLeaveDomain.checkOutAttendance(id, checkOutAt); }
export function correctAttendance(id, data = {}) { return attendanceLeaveDomain.correctAttendance(id, data); }
...
export function getLeaves() { return attendanceLeaveDomain.getLeaves(); }
export function getLeavesByEmployee(empId) { return attendanceLeaveDomain.getLeavesByEmployee(empId); }
export function getLeaveTypes() { return attendanceLeaveDomain.getLeaveTypes(); }
export function createLeave(data) { return attendanceLeaveDomain.createLeave(data); }
export function updateLeave(id, data) { return attendanceLeaveDomain.updateLeave(id, data); }
export function withdrawLeave(id, note = '') { return attendanceLeaveDomain.withdrawLeave(id, note); }
export function deleteLeave() { return attendanceLeaveDomain.deleteLeave(); }
...
const competitorPhotoDomain = createCompetitorPhotoDomain({
  getDB,
  saveDB,
  scoped,
  getActor,
...
export { FIELD_PHOTO_TYPES };

export function getCompetitors() { return competitorPhotoDomain.getCompetitors(); }
export function getCompetitor(id) { return competitorPhotoDomain.getCompetitor(id); }
export function createCompetitor(data) { return competitorPhotoDomain.createCompetitor(data); }
export function updateCompetitor(id, data) { return competitorPhotoDomain.updateCompetitor(id, data); }
export function deleteCompetitor(id) { return competitorPhotoDomain.deleteCompetitor(id); }
export function getCompetitorProducts() { return competitorPhotoDomain.getCompetitorProducts(); }
export function getCompetitorProductsByCompetitor(competitorId) { return competitorPhotoDomain.getCompetitorProductsByCompetitor(competitorId); }
export function createCompetitorProduct(data) { return competitorPhotoDomain.createCompetitorProduct(data); }
export function updateCompetitorProduct(id, data) { return competitorPhotoDomain.updateCompetitorProduct(id, data); }
export function deleteCompetitorProduct(id) { return competitorPhotoDomain.deleteCompetitorProduct(id); }
export function getCompetitorIntel() { return competitorPhotoDomain.getCompetitorIntel(); }
export function getCompetitorIntelByOutlet(outletId) { return competitorPhotoDomain.getCompetitorIntelByOutlet(outletId); }
export function getCompetitorIntelByVisit(visitId) { return competitorPhotoDomain.getCompetitorIntelByVisit(visitId); }
export function getCompetitorIntelByEmployee(empId) { return competitorPhotoDomain.getCompetitorIntelByEmployee(empId); }
export function createCompetitorIntel(data) { return competitorPhotoDomain.createCompetitorIntel(data); }
export function updateCompetitorIntel(id, data) { return competitorPhotoDomain.updateCompetitorIntel(id, data); }
export function getPromoTypes() { return competitorPhotoDomain.getPromoTypes(); }
export function getPromoTypeLabel(code, customNote = '') { return competitorPhotoDomain.getPromoTypeLabel(code, customNote); }
export function getFieldPhotos() { return competitorPhotoDomain.getFieldPhotos(); }
export function getFieldPhotosByEmployee(empId) { return competitorPhotoDomain.getFieldPhotosByEmployee(empId); }
export function getFieldPhotosByOutlet(outletId) { return competitorPhotoDomain.getFieldPhotosByOutlet(outletId); }
export function getFieldPhotosByVisit(visitId) { return competitorPhotoDomain.getFieldPhotosByVisit(visitId); }
export function getAccessibleFieldPhotos(empId, isManagerRole) { return competitorPhotoDomain.getAccessibleFieldPhotos(empId, isManagerRole); }
export function createFieldPhoto(data) { return competitorPhotoDomain.createFieldPhoto(data); }
export function updateFieldPhoto(id, data) { return competitorPhotoDomain.updateFieldPhoto(id, data); }
export function deleteFieldPhoto(id) { return competitorPhotoDomain.deleteFieldPhoto(id); }
export function deleteCompetitorIntel(id) { return competitorPhotoDomain.deleteCompetitorIntel(id); }
export function getCompetitorAnalysisSummary() { return competitorPhotoDomain.getCompetitorAnalysisSummary(); }

...
- Hash PBKDF2 lama di bawah baseline serta verifier legacy `sha256# Security Policy and Boundaries
...
## Password storage dan recovery
 ...
 tetap dapat diverifikasi untuk migration-on-login. Hash PBKDF2 di atas batas runtime ditolak dengan aman, bukan diteruskan menjadi error 500.

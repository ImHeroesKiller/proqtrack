...
| Milestone config | `M7` |
| Service Worker | `proqtrack-v12.16` |
...
- PWA cache baseline saat ini `proqtrack-v12.16`; precache hanya memasukkan application shell yang runtime-reachable dan assets.
...
4. Runtime bootstrap naik ke `p3-runtime-2026-09-23` dan service-worker cache ke `proqtrack-v12.16`.
